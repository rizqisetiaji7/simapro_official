<div class="form-row">
  <div class="col-12 mb-3">
    <label for="project_task_name">Nama Sub-Elemen Proyel <span class="text-danger small">*</span></label>
    <input type="text" name="project_task_name" id="project_task_name" class="form-control" value="Pengaspalan Parkir" autocomplete="off">
  ...
  <div class="col-12 mb-3">
    ...
    <select id="task_priority_level" name="task_priority_level" class="form-control">
      ...
      <option value="" selected>Menengah</option>

...
<div class="row">
    ...
    <div class="col-12">
        <div class="form-group">
            ...
            <input type="text" id="project_name" name="proyek_name" class="form-control" required placeholder="Ketik nama proyek...">
            <div class="invalid-feedback"></div>
        </div>
        <div class="form-group">
            <label for="ID_pm">Penanggung Jawab Lapangan <span class="text-danger small">*</span></label>
            <select name="ID_pm" class="custom-select" require>
        ...
        <div class="form-group">
            ...
            <input type="text" id="project_address" name="project_address" class="form-control" required placeholder="Ketik nama proyek...">
            <div class="invalid-feedback"></div>
        </div>
        <div class="form-group">

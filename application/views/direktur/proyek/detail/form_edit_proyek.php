...
<div class="row">
    ...
    <div class="col-12">
        ...
        <div class="form-group">
            ...
            <input type="text" id="project_name" name="project_name" class="form-control" autocomplete="off" value="<?= $project->project_name ?>" placeholder="Ketik nama proyek...">
        ...
        <div class="form-group">
            ...
            <input type="text" id="project_address" name="project_address" class="form-control" value="<?= $project->project_address ?>" autocomplete="off" placeholder="Ketik nama proyek...">
            <div class="invalid-feedback"></div>
        </div>
        <div class="form-group">

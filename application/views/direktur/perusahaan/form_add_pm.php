...
<div style="min-height: 200px; border-radius: 8px; background: #f7f7f7;" class="d-flex flex-column align-items-center justify-content-center py-4 px-3 mb-3">
  ...
  <div class="d-flex flex-column align-items-center mb-3 text-center">
    <p class="text-secondary mb-0 mr-2">Unggah foto atau gambar dari komputer. <strong class="text-primary" style="cursor: pointer;" id="chooseFileImage">Pilih file</strong></p>
...
<div class="form-row">
  <div class="col-12 mb-3">
    ...
    <input type="text" name="user_fullname" id="user_fullname" class="form-control" placeholder="Nama Proyek Manajer" autocomplete="off">
...
<div class="form-row">
  ...
  <div class="col-12 mb-3">
    ...
    <textarea name="user_address" id="user_address" class="form-control" rows="3" placeholder="Isi alamat..."></textarea>
  </div>
</div>
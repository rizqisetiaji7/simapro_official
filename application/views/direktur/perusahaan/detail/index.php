                                        ...
                                        <?php if ($director->num_rows() > 0) { ?> 
                                            <ul class="personal-info">
                                                ...
                                                <li class="mt-4">
                                                    ...
                                                    <?php } else { ?>
                                                        <button class="btn btn-secondary btn-sm" data-toggle="tooltip" title="Lihat detail"><i class="fa-solid fa-up-right-from-square"></i></button>
                                                        <button class="btn btn-success btn-sm" data-toggle="tooltip" title="Edit profile"><i class="fa-solid fa-user-pen"></i></button>

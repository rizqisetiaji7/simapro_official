<div class="form-row mb-3">
  <div class="col-12">
    ...
    <label for="comp_name">Nama anak perusahaan</label>
...
<div class="form-row mb-3">
  <div class="col-12">
    <label for="comp_email">Alamat Email</label>
...
<div class="form-row mb-3">
  <div class="col-12 col-md-6 col-lg-8 mb-3">
    <label for="comp_phone">Nomor Telepon</label>
  ...
  <div class="col-12 col-md-6 col-lg-4 mb-3">
    <label for="comp_type">Tipe</label>
...
<div class="form-row align-items-center mb-4">
  ...
  <div class="col-12 col-sm-8 col-md-9">
    <label for="upload_logo">Ubah logo</label>
...
<div class="form-row">
  ...
  <div class="col-12">
    <label for="comp_desc">Deskripsi</label>

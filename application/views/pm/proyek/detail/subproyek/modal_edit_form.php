<input type="hidden" name="subproject_id" value="">
...
<div class="form-row">
  <div class="col-12 mb-3">
    ...
    <input type="text" name="subproject_name" id="subproject_name" class="form-control" autocomplete="off" value="Pembangunan Area Parkir">
    <div class="invalid-feedback"></div>
  </div>

  <div class="col-12 mb-3">
    <label for="subproject_deadline">Deadline / Proyek Selesai <span class="text-danger small">*</span></label>
    <input type="date" name="subproject_deadline" id="subproject_deadline" class="form-control" value="" autocomplete="off">
    <div class="invalid-feedback"></div>
  </div>
  ...
  <div class="col-12 mb-2">
    ...
    <div class="input-radio">
      <!-- Color 1 -->
      <input type="radio" id="kanbanSuccess" name="panel_color" value="kanban-success" class="d-none custom-radio-input">
      ...
      <!-- Color 5 -->
      <input type="radio" id="kanbanPurple" name="panel_color" value="kanban-purple" class="d-none custom-radio-input" checked="checked">

...
<div class="modal fade" id="modalUploadDoc" tabindex="-1" role="dialog" aria-labelledby="modalUploadDocTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
    <form class="modal-content" id="formUpload_doc" action="" method="post" accept-charset="utf-8" enctype="multipart/form-data">
      <div class="modal-body">
        <input type="file" name="project_photo" id="upPhotoProject" accept=".jpg,.png,.jpeg" class="d-none">
        <div style="min-height: 200px; border-radius: 8px; background: #f7f7f7;" class="d-flex flex-column align-items-center justify-content-center py-4 px-3">
          ...
          <div id="docFileName" class="text-center py-2 px-3 d-none" style="border-radius: 4px; position: relative; overflow: hidden; background: #f0f0f0;"></div>

	...
	<?php foreach($projects->result() as $project) { ?>
		<tr>
		  ...
		  <td class="text-nowrap">
		      <div class="d-flex align-items-center">
		          <?php if ($project->user_id != NULL) { ?>
		              <img src="<?= $project->user_profile == 'default-avatar.jpg' ? base_url('assets/img/default-avatar.jpg') : base_url('uploads/profile/'.$project->user_profile) ?>" class="rounded-lg" width="40">
		              <div class="ml-3">
		  ...
		  <td class="text-nowrap text-center">
		      <a href="<?= site_url('pm/riwayat/detail/'.$project->company_id.'/'.$project->projectID) ?>" class="btn btn-sm my-1 btn-primary text-nowrap" title="Lihat Proyek">Detail</a>
		  </td>
		</tr>
	<?php } ?>
<?php } else { ?>

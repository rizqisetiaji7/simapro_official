		...
		<tr>
		  <td class="text-nowrap">
		      <div class="d-flex align-items-center">
		          ...
		          <div class="ml-3">
		              <h5 class="mb-0"><?= character_limiter($ft->project_name, 40, ' ...') ?></h5>
		  ...
		  <td class="text-nowrap text-center">
		      <a href="<?= site_url('pm/riwayat/detail/'.$ft->company_id.'/'.$ft->projectID) ?>" class="btn btn-sm my-1 btn-primary text-nowrap" data-toggle="tooltip" title="Lihat Proyek">Detail</a>
		  </td>
		</tr>
	<?php } ?>
<?php } else { ?>
